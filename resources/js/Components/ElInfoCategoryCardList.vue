...
watch(
  () => props,
  () => {
    helpers.devConsole.log('categoryCardProp', props.categoryCardProp.textContent);
    updateVisibleItems();
...
<template>
  ...
  <div class="border-gray grid w-full grid-cols-12 border-l">
    <div
      class="border-gray col-span-6 flex flex-col items-end justify-between border-r px-2 pb-5 md:col-span-4 lg:col-span-2"
        ...
        <div class="w-full flex-col items-center justify-between">
          ...
          <div class="flex h-[50px] flex-col items-end justify-end">
            ...
            <a
              :href="helpers.generateHref(item)"
              :target="helpers.generateTarget(item)"
              class="text-base font-bold md:text-base"
            >
